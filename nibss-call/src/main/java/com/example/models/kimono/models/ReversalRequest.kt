...
import com.example.models.kimono.models.CardData
import com.example.models.kimono.models.PinData
import com.example.models.kimono.models.TerminalInformation
...
internal data class ReversalRequest(
    ...
    companion object {
        fun create(purchaseRequest: TransactionRequest): ReversalRequest {
            ...
            return ReversalRequest(
                    ...
                    stan = purchaseRequest.stan,
                    pinData = purchaseRequest.pinData,
                    keyLabel = purchaseRequest.keyLabel,
                    retrievalReferenceNumber = purchaseRequest.retrievalReferenceNumber
            )
        }
    }
}