...
sealed class EmvMessage {
     ...
     *
     */
    class CardRead(val cardType: CardType, val cardPan: String): EmvMessage()
    ...
    /**
     * Indicates when clss has been read
     *@returns EmvMessage
     *
     */
    object ClssCardDetected : EmvMessage()

    /**
     * Fix for contactless cards types for kozen specifically to be identified
     */
    class SetClssCardType(val cardType: CardType): EmvMessage()

    /**
     * Indicates when a card has been detected
     */
    class ClssTransError(val error: String): EmvMessage()
    ...
    /**
     * Indicates when a clss transaction is canceled
     */
    object ClssCanceled: EmvMessage()
    ...
    class EmvProcessed(var iccData: EmvData, var emvResult: EmvResult): EmvMessage()
